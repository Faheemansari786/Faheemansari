...
BOT_TOKEN = environ.get('BOT_TOKEN', "6464819706:AAHx56v2Ni4K_cm5rl2wlaNHTF2m9WLRVKs")
...
URL = "https://lisabo-082f98dcfaa1.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://https://lisabo-082f98dcfaa1.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lisabo-082f98dcfaa1.herokuapp.com/".format(FQDN)
else:
    URL = "https://lisabo-082f98dcfaa1.herokuapp.com/".format(FQDN)
